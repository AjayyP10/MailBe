            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl p-8 space-y-6">
                ...
                <div className="space-y-4">
                    <input
                        type="email"
                        placeholder="To"
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-transparent text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        value={to}
                    ...
                    <textarea
                        ...
                        className="w-full h-48 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-transparent text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none"
                        value={body}
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    <button
                        onClick={handleSend}
                        disabled={sending}
                        className="px-6 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded font-medium disabled:opacity-50 flex items-center justify-center"
                    >
                        {sending ? (
